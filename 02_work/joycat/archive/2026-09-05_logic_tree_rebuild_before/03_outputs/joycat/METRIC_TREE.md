...
> Phạm vi: Viết công thức cho các KPI trong `KPI_TREE.md`; định nghĩa bốn chiều và coverage sáu cặp nằm tại `KHUNG_PHAN_TICH_CONG_THUC_VA_MAPPING_JOYCAT.md`. Chưa phân tích nguyên nhân và chưa kết luận tỷ lệ 5–10%.
