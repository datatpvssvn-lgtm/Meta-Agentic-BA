# JOYCAT — Khung phân tích, công thức và mapping Ads Cost
...
> **Vai trò tài liệu:** đây là reference model hợp nhất để lưu công thức, chiều phân tích, mapping, coverage và data contract. Đây **không phải Logic Tree thuần**. Logic Tree đúng nghĩa sẽ chọn câu hỏi, rẽ giả thuyết, kiểm tra bằng chứng và đi tới quyết định; nó được dựng gọn từ tài liệu nền này sau khi Duy/cậu Sinh khóa phạm vi cần phân tích.
