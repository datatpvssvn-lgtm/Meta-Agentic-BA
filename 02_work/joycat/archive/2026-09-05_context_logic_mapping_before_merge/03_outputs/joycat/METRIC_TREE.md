...
> Phạm vi: Viết công thức cho các KPI trong `KPI_TREE.md`; định nghĩa bốn chiều và coverage sáu cặp nằm tại `DIMENSION_MAPPING_VA_DO_PHU_DATASET.md`. Chưa phân tích nguyên nhân và chưa kết luận tỷ lệ 5–10%.
